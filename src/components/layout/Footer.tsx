          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="text-center lg:text-left">
              ...
              <p className="text-primary-foreground/70 max-w-md">
                Subscribe for exclusive deals, new product launches, and expert battery tips.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <input
                ...
                className="h-12 px-5 rounded-lg bg-primary-foreground/10 border border-primary-foreground/20 text-primary-foreground placeholder:text-primary-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary-foreground/30 w-full sm:w-72"
              />
              <Button className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 h-12 px-8 rounded-lg font-semibold">
                Subscribe
              </Button>
            </div>
          </div>
