  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroBg}
          alt="SOK Battery Professional Installation"
      ...
      <div className="container relative z-10 py-20 lg:py-32">
        <div className="max-w-2xl space-y-8">
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-white/70 max-w-lg animate-slide-up" style={{ animationDelay: "0.2s" }}>
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap items-center gap-8 pt-6 animate-slide-up" style={{ animationDelay: "0.4s" }}>
