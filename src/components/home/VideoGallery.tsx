...
export const VideoGallery = () => {
  ...
  return <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        {/* Featured Video */}
        <div className="mb-8">
          <div className="relative aspect-video rounded-2xl overflow-hidden bg-muted cursor-pointer group" onClick={() => window.open(`https://youtube.com/watch?v=${featuredVideo.youtubeId}`, "_blank")}>
            <img src={featuredVideo.thumbnail} alt={featuredVideo.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {gridVideos.map(video => <div key={video.id} className="group cursor-pointer" onClick={() => setFeaturedVideo(video)}>
